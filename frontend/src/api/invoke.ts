...
const COMMAND_BY_PATH: Record<string, string> = {
  '/reader3/health': 'health',
  '/reader3/getBookSource': 'get_book_source',
  '/reader3/getBookSources': 'get_book_sources',
  '/reader3/getDefaultBookSourceOwner': 'get_default_book_source_owner',
  '/reader3/loginBookSource': 'login_book_source',
  '/reader3/getExploreKinds': 'get_explore_kinds',
  ...
  '/reader3/setAsDefaultBookSources': 'set_as_default_book_sources',
  '/reader3/readRemoteSourceFile': 'read_remote_source_file',
  '/reader3/readSourceFile': 'read_source_file',
  '/reader3/searchBook': 'search_book',
  '/reader3/exploreBook': 'explore_book',
  '/reader3/searchBookMulti': 'search_book_multi',
  '/reader3/getBookshelf': 'get_bookshelf',
  '/reader3/getShelfBook': 'get_shelf_book',
  ...
  '/reader3/saveBookGroupOrder': 'save_book_group_order',
  '/reader3/deleteBookGroup': 'delete_book_group',
  '/reader3/saveBookGroupId': 'save_book_group_id',
  '/reader3/addBookGroupMulti': 'add_book_group_multi',
  '/reader3/removeBookGroupMulti': 'remove_book_group_multi',
  '/reader3/uploadTxtBook': 'upload_txt_book',
  '/reader3/uploadEpubBook': 'upload_epub_book',
  ...
  '/reader3/getInvalidBookSources': 'get_invalid_book_sources',
  '/reader3/cacheBookSSE': 'cache_book_sse',
  '/reader3/searchBookMultiSSE': 'search_book_multi_sse',
  '/reader3/searchBookSourceSSE': 'search_book_source_sse',
  '/reader3/getAvailableBookSource': 'get_available_book_source',
  '/reader3/getAvailableBookSourceSSE': 'get_available_book_source_sse',
  '/reader3/bookSourceDebugSSE': 'book_source_debug_sse',
  ...
  '/reader3/readRssSourceFile': 'read_rss_source_file',
  ...
  '/reader3/getAiBookMemory': 'get_ai_book_memory',
  '/reader3/saveAiBookMemory': 'save_ai_book_memory',
  '/reader3/deleteAiBookMemory': 'delete_ai_book_memory',
  '/reader3/getAiModelConfig': 'get_ai_model_config',
  '/reader3/saveAiModelConfig': 'save_ai_model_config',
  '/reader3/aiProxy': 'ai_proxy',
  '/reader3/aiProxyImage': 'ai_proxy_image',
  ...
  '/reader3/uploadFileToWebdav': 'upload_file_to_webdav',
  ...
  '/reader3/saveUserConfig': 'save_user_config',
  '/reader3/getUserConfig': 'get_user_config',
  '/reader3/uploadFile': 'upload_file',
  '/reader3/deleteFile': 'delete_file',
  '/reader3/getTxtTocRules': 'get_txt_toc_rules',
}
